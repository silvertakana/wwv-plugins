# @worldwideview/wwv-plugin-observatories-wikidata

WorldWideView plugin - Astronomical Observatories

## Description

Astronomical observatories and radio telescopes (Wikidata). A static, point-based globe layer (baked snapshot - not a live feed).
...
```bash
npm install @worldwideview/wwv-plugin-observatories-wikidata
```
