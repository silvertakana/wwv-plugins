# @worldwideview/wwv-plugin-eez-boundaries

WorldWideView plugin - EEZ Boundaries

## Description

World Exclusive Economic Zones, territorial seas and high seas from MarineRegions (World EEZ v12). A static, point-based globe layer (baked snapshot - not a live feed).
...
```bash
npm install @worldwideview/wwv-plugin-eez-boundaries
```
