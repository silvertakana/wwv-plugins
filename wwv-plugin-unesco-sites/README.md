# @worldwideview/wwv-plugin-unesco-sites

WorldWideView plugin - UNESCO World Heritage

## Description

1,273 UNESCO World Heritage sites (UNESCO, baked snapshot). A static, point-based globe layer (baked snapshot - not a live feed).
...
```bash
npm install @worldwideview/wwv-plugin-unesco-sites
```
