 ...
 * power-plants plugin. Exits 0 on PASS, 1 on FAIL.
 *
 * Checks:
 ...
 *   - required properties (name, capacity_mw) present
...
const REQUIRED_PROPS = ["name", "capacity_mw"];
...
console.log(`power-plants data check`);
