# @worldwideview/wwv-plugin-earth-impact-craters

WorldWideView plugin - Earth Impact Craters

## Description

Confirmed Earth impact crater locations. A static, point-based globe layer (baked snapshot - not a live feed).
...
```bash
npm install @worldwideview/wwv-plugin-earth-impact-craters
```
