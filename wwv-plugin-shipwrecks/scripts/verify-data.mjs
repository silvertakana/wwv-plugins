 ...
 * shipwrecks plugin. Exits 0 on PASS, 1 on FAIL.
 *
 * Checks:
...
if (sizeBytes >= MAX_SIZE_BYTES) {
    fail(`data.json is ${(sizeBytes / 1024).toFixed(1)} KB, exceeds the ${MAX_SIZE_BYTES / 1024} KB cap`);
}
...
console.log(`shipwrecks data check`);
console.log(`  features:        ${features.length}`);
console.log(`  file size:       ${(sizeBytes / 1024).toFixed(1)} KB (cap ${MAX_SIZE_BYTES / 1024} KB)`);
