 ...
 * ripe-atlas plugin. Exits 0 on PASS, 1 on FAIL.
 *
 * Checks:
 ...
 *   - required properties (name, probe_id) present
...
const REQUIRED_PROPS = ["name", "probe_id"];
...
console.log(`ripe-atlas data check`);
