...
export default class AutoStaticPlugin {
    ...
    description = "RIPE Atlas network measurement probes worldwide";
    icon = Activity;
    ...
    renderEntity(_entity: any) {
        if (!this._iconUrl) {
            this._iconUrl = createSvgIconUrl(Activity, { color: "#38bdf8" });
        }
